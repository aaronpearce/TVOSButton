...
open class TVOSButton: UIButton {
    ...
    private func commonInit() {
        ...
        tvosButton?.fill(to: self)
        tvosButtonBackgroundImageView?.fill(to: tvosButton!)
        tvosCustomContentView?.fill(to: tvosButton!)
        tvosBadge?.fill(to: tvosButton!)
        tvosTextLabel?.fill(to: tvosButton!)
        
        // add title constraints
        tvosTitleLabel?.fillHorizontal(to: self)
